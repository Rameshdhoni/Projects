...
const AddMenu = () => {
    ...
    return (
        <Container maxWidth="sm">
            <Box my={5}>
                <Typography variant="h5" align="center">Add Menu Details</Typography>
                <FormGroup>
                    <FormControl>
                    ...
                    <Box my={3}>
                        <Button variant="text" onClick={() => addMenuDetails()} color="primary" align="center">Add New Item</Button>
