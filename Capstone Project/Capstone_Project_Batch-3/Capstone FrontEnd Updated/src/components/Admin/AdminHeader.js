...
export default function AdminHeader() {
    ...
    const renderMenu = (
        ...
        >
            <MenuItem component={Link} to={`/adminprofile`}>Profile</MenuItem>
        ...
        <Box sx={{ flexGrow: 1 }}>
            ...
            /> */}
                    ...
                    <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
                        ...
                        <IconButton size="large" aria-label="show  Add Post" color="inherit">
                            <Badge badgeContent={'User'} color="error">
                        ...
                        <IconButton size="large" aria-label="show  Add Post" color="inherit">
                            <Badge badgeContent={'Approve'} color="error">
                                <AddCircleOutlineIcon onClick={handlePostApprove} />
                            </Badge>
                        </IconButton>
                        <IconButton size="large" aria-label="show 4 new mails" color="inherit">
