                            ...
                            <div className="form-body">
                                ...
                                <center>
                                    ...
                                    <div>
                                        ...
                                        {/* <div>
                                            <Button variant="contained" color="primary" style={{ margin: '0px 20px' }} component={Link} to={`/update/${data.id}`}>Approve</Button>
                                        
                                            <Button variant="contained" color="secondary" style={{ margin: '0px 20px' }} onClick={() => deletePosts(data.id)}>Reject</Button>
                                            </div>  */}
                                    </div><br /><br />
                                </center>
                            </div>
